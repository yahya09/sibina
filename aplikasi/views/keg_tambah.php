...
<script type="text/javascript">
	function kirim(borang) {
		...
		$(".boxy-content").load('<?php echo site_url("log/tambah_keg") ?>',{kegid:data[0], tgl:data[1], tempat:data[2], jenis:data[3], deskripsi:data[4], absen:isi.toString(), ids:mid, submit:true},function(response, status, xhr) {});
		return false;
	}
</script>
<div id="tabel">
<?php
	...
	$this->table->add_row(form_label('Jenis Kegiatan','jenis'),form_input(array('name'=>'jenis')),form_error('jenis'));
